...
int main() {
    ...
    for (int i = 0; i < 7; i++) {
        const int dias_semana[7] = { 0, 1, 2, 3, 4, 5, 6 };
...
void boas_vindas() {
    ...
    printf(
        "No final, mostraremos quantos carros passaram em cada dia da semana, o total semanal e deixaremos em vermelho e negrito o dia de maior pico.\n");
}
